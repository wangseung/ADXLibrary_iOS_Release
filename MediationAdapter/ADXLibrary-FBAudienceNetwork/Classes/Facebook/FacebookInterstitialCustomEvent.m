...
{
    ADXLogEvent(ADX_PLATFORM_FACEBOOK, ADX_INVENTORY_INTERSTITIAL, ADX_EVENT_LOAD);
...
{
    ADXLogEvent(ADX_PLATFORM_FACEBOOK, ADX_INVENTORY_INTERSTITIAL, ADX_EVENT_LOAD_SUCCESS);
...
{
    ADXLogEvent(ADX_PLATFORM_FACEBOOK, ADX_INVENTORY_INTERSTITIAL, ADX_EVENT_IMPRESSION);
...
- (void)interstitialAd:(FBInterstitialAd *)interstitialAd didFailWithError:(NSError *)error
{
    ...
    ADXLogEvent(ADX_PLATFORM_FACEBOOK, ADX_INVENTORY_INTERSTITIAL, errorMsg);
...
{
    ADXLogEvent(ADX_PLATFORM_FACEBOOK, ADX_INVENTORY_INTERSTITIAL, ADX_EVENT_CLICK);
...
{
    ADXLogEvent(ADX_PLATFORM_FACEBOOK, ADX_INVENTORY_INTERSTITIAL, ADX_EVENT_CLOSED);
