...
{
    ADXLogEvent(ADX_PLATFORM_FACEBOOK, ADX_INVENTORY_BANNER, ADX_EVENT_LOAD);
...
- (void)adView:(FBAdView *)adView didFailWithError:(NSError *)error
{
    ...
    ADXLogEvent(ADX_PLATFORM_FACEBOOK, ADX_INVENTORY_BANNER, errorMsg);
...
{
    ADXLogEvent(ADX_PLATFORM_FACEBOOK, ADX_INVENTORY_BANNER, ADX_EVENT_LOAD_SUCCESS);
...
{
    ADXLogEvent(ADX_PLATFORM_FACEBOOK, ADX_INVENTORY_BANNER, ADX_EVENT_IMPRESSION);
...
{
    ADXLogEvent(ADX_PLATFORM_FACEBOOK, ADX_INVENTORY_BANNER, ADX_EVENT_CLICK);
