...
- (void)requestAdWithCustomEventInfo:(NSDictionary *)info adMarkup:(NSString *)adMarkup {
  ADXLogEvent(ADX_PLATFORM_ADMOB, ADX_INVENTORY_NATIVE, ADX_EVENT_LOAD);
  ...
  if (self.admobAdUnitId == nil) {
    self.admobAdUnitId = info[@"adUnitID"];
    if (self.admobAdUnitId == nil) {
...
- (void)adLoader:(GADAdLoader *)adLoader didFailToReceiveAdWithError:(GADRequestError *)error {
  ...
  ADXLogEvent(ADX_PLATFORM_ADMOB, ADX_INVENTORY_NATIVE, errorMsg);
...
- (void)adLoader:(nonnull GADAdLoader *)adLoader
  ...
  ADXLogEvent(ADX_PLATFORM_ADMOB, ADX_INVENTORY_NATIVE, ADX_EVENT_LOAD_SUCCESS);
