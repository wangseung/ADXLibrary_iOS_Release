...
- (void)requestRewardedAd {
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_RV, ADX_EVENT_LOAD);
...
- (void)rewardedVideoDidLoad:(NSString *)instanceId {
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_RV, ADX_EVENT_LOAD_SUCCESS);
...
- (void)rewardedVideoDidOpen:(NSString *)instanceId {
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_RV, ADX_EVENT_IMPRESSION);
...
- (void)rewardedVideoDidFailToLoadWithError:(NSError *)error instanceId:(NSString *)instanceId {
    ...
    ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_RV, errorMsg);
...
- (void)rewardedVideoAdRewarded:(NSString *)instanceId {
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_RV, ADX_EVENT_REWARD);
...
- (void)rewardedVideoDidClick:(NSString *)instanceId {
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_RV, ADX_EVENT_CLICK);
...
- (void)rewardedVideoDidClose:(NSString *)instanceId {
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_RV, ADX_EVENT_CLOSED);
