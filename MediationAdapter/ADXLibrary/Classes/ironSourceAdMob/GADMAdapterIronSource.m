...
- (void)getInterstitial {
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_INTERSTITIAL, ADX_EVENT_LOAD);
...
- (void)interstitialDidLoad:(NSString *)instanceId {
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_INTERSTITIAL, ADX_EVENT_LOAD_SUCCESS);
...
- (void)interstitialDidFailToLoadWithError:(NSError *)error instanceId:(NSString *)instanceId {
  ...
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_INTERSTITIAL, errorMsg);
...
- (void)interstitialDidOpen:(NSString *)instanceId {
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_INTERSTITIAL, ADX_EVENT_IMPRESSION);
...
- (void)interstitialDidClose:(NSString *)instanceId {
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_INTERSTITIAL, ADX_EVENT_CLOSED);
...
- (void)didClickInterstitial:(NSString *)instanceId {
  ADXLogEvent(ADX_PLATFORM_IRONSOURCE, ADX_INVENTORY_INTERSTITIAL, ADX_EVENT_CLICK);
