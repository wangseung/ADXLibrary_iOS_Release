Pod::Spec.new do |s|
  ...
  s.frameworks = ["UIKit", "GLKit", "CoreMotion", "CoreGraphics", "Foundation", "AdSupport", "StoreKit", "QuartzCore", "CoreLocation", "CoreTelephony", "MobileCoreServices", "Accelerate", "AVFoundation", "WebKit", "SystemConfiguration", "VideoToolbox", "AudioToolbox"]
